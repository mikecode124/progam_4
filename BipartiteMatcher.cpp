...
BipartiteMatcher::BipartiteMatcher(const string& filename) {
...
void BipartiteMatcher::addEdge(int u, int v, int cap) {
...
//  ensuring O(n^2) run.
int BipartiteMatcher::dfs(int u, int pushed) {
...
//              paths remain.
int BipartiteMatcher::runMaxFlow() {
    int totalFlow = 0;
